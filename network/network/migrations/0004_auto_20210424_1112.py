# Generated by Django 3.1.7 on 2021-04-24 11:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('network', '0003_auto_20210424_1037'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='user',
            name='followings',
            field=models.ManyToManyField(blank=True, null=True, related_name='_user_followings_+', to=settings.AUTH_USER_MODEL),
        ),
